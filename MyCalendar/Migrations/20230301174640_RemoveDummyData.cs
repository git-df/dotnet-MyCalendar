...
namespace MyCalendar.Migrations
{
    ...
    public partial class RemoveDummyData : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Events",
                columns: new[] { "Id", "CreatedBy", "CreatedDate", "Description", "EndEventDate", "EventDate", "Label", "ModifiedBy", "ModifiedDate", "Title", "UserId" },
                values: new object[,]
                {
                    { 1, "SYSTEM", null, "Wielkie święto", new DateTime(2000, 12, 12, 1, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2000, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Urodziny", null, null, "Moje urodziny", new Guid("fb8e707d-9a9d-40f6-9819-968add26204e") },
                    { 2, "SYSTEM", null, "Wyjazd do Włoch", new DateTime(2024, 6, 1, 1, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Wycieczka", null, null, "Wakacje", new Guid("fb8e707d-9a9d-40f6-9819-968add26204e") },
                    { 3, "SYSTEM", null, "Nie zapomnij wziąść wolne w pracy", new DateTime(2000, 1, 10, 1, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Urodziny", null, null, "Urodziny Adama", new Guid("fb8e707d-9a9d-40f6-9819-968add26204e") },
                    { 4, "SYSTEM", null, "Nie zapomnij zapłacić", new DateTime(2000, 1, 1, 1, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2000, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Rachunki", null, null, "Rachunek za prąd", new Guid("9ce89f11-4d8b-4d78-98ee-4ef4640dfadf") },
                    { 5, "SYSTEM", null, "Termin do końca miesiąca", new DateTime(2000, 1, 10, 1, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2000, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Rachunki", null, null, "Rachunek za wodę", new Guid("9ce89f11-4d8b-4d78-98ee-4ef4640dfadf") },
                    { 6, "SYSTEM", null, "Koncert w Warszawie", new DateTime(2025, 8, 15, 1, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 8, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Rozrywka", null, null, "Koncert", new Guid("9ce89f11-4d8b-4d78-98ee-4ef4640dfadf") }
                });
